...
class DeepSpeech(nn.Module):
    ...
    def decode(self, encoder_outputs, encoder_hidden, y):
        """
	...
	# TODO il faut changer l'initialisation de la couche de decoder avec la dernier couche de l'encoder
        decoder_hidden = Variable(torch.rand(1,y.size(1),self._dec_hidden_size)).cuda()  #torch.zeros(1, y.size(0),self._dec_hidden_size) # 1 x B x  H
	...
	context = self.fcsw(encoder_outputs)

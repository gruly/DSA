...
#SBATCH --time=30-0
#SBATCH --error=/lium/raid01_b/ghannay/post-doc/IWSLT-2018/speech/EN_TED_LIUM2_Seq2Seq.err
#SBATCH --output=/lium/raid01_b/ghannay/post-doc/IWSLT-2018/speech/EN_TED_LIUM2_Seq2Seq.out
...
python train.py \
  ...
  --val_manifest $VAL --hidden_size 800   --exp_mode TED_LIUM2_Deep_Speech_Seq2Seq\
